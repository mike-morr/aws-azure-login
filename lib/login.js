...
module.exports = {
    async loginAsync(profileName, mode, disableSandbox, noPrompt, disableChromeNetworkService, awsNoVerifySsl, disableChromeSeamlessSso, noDisableExtensions) {
        ...
        const samlResponse = await this._performLoginAsync(loginUrl, headless, disableSandbox, cliProxy, noPrompt, disableChromeNetworkService, profile.azure_default_username, 
            profile.azure_default_password, disableChromeSeamlessSso, profile.azure_default_remember_me, noDisableExtensions);
    ...
    async loginAll(mode, disableSandbox, noPrompt, disableChromeNetworkService, awsNoVerifySsl, disableChromeSeamlessSso, forceRefresh, noDisableExtensions) {
        ...
        for (const profile of profiles) {
            ...
            await this.loginAsync(profile, mode, disableSandbox, noPrompt, disableChromeNetworkService, awsNoVerifySsl, disableChromeSeamlessSso, noDisableExtensions);
        }
    },
     ...
     * @param {bool} [disableChromeNetworkService] - Enable chrome network service.
     * @param {string} [defaultUsername] - The default username
     * @param {string} [defaultPassword] - The default password
     * @param {bool} [disableChromeSeamlessSso] - chrome seamless SSO
     ...
     * @private
     */
    async _performLoginAsync(url, headless, disableSandbox, cliProxy, noPrompt, disableChromeNetworkService, defaultUsername, defaultPassword, disableChromeSeamlessSso, rememberMe, noDisableExtensions) {
        ...
        try {
            ...
            if (!disableChromeNetworkService) args.push('--enable-features=NetworkService');
            if (!disableChromeSeamlessSso) args.push(
